...
function wpa_register_scripts() {
	...
	wp_register_script( 'wpa-toolbar', plugins_url( 'js/wpa-toolbar.js', __FILE__ ), array(), $wpa_version, true );
	wp_register_script( 'ui-a11y', plugins_url( 'js/toolbar/js/a11y.js', __FILE__ ), array( 'jquery' ), $wpa_version, true );
}
